...
async def get_latest_user_context(
    ...
    try:
        ...
        result = await context_bundle_service.get_latest_context_bundle(
            user.id, jwt_token
        )
...
async def get_context_bundles(
    ...
    try:
        logger.info(
            f"API request to get analysis bundles for conversation: {conversation_id}"
        )
        result = await context_bundle_service.get_bundles_by_conversation(
        ...
        if result.get("success"):
            ...
            logger.info(
                f"Retrieved {len(bundles)} analysis bundles for conversation: {conversation_id}"
            )
            return bundles
        else:
...
async def delete_analysis_bundle(
    ...
    try:
        ...
        result = await context_bundle_service.delete_analysis_bundle(
            bundle_id, jwt_token
        )
        return result
    except Exception as e:
...
async def delete_conversation(
    ...
    try:
        ...
        result = await conversation_service.delete_conversation(
            conversation_id, user, jwt_token
        )
        return result
    except Exception as e:
...
async def delete_conversation_bundles(
    ...
    try:
        logger.info(
            f"API request to delete all analysis bundles for conversation: {conversation_id}"
        )
        result = await context_bundle_service.delete_conversation_bundles(
            conversation_id, jwt_token
        )
        return result
    except Exception as e:
...
async def create_workout(
    ...
    try:
        ...
        result = await workout_service.create_workout(
            user.id, workout, jwt_token, user_bodyweight_kg
        )
        return result
    except Exception as e:
...
async def update_workout(
    ...
    try:
        ...
        result = await workout_service.update_workout(
            workout_id, workout, jwt_token, user_bodyweight_kg
        )
        return result
    except Exception as e:
...
async def create_conversation(
    ...
    try:
        ...
        result = await conversation_service.create_conversation(
            data.get("title"), data.get("configName"), user, jwt_token
        )
        return result
    except Exception as e:
...
async def get_user_conversations(
    ...
    try:
        ...
        if result.get("success"):
            ...
            logger.info(
                f"Retrieved {len(conversations)} active conversations for user: {user.id}"
            )
...
async def save_message(
    ...
    try:
        ...
        result = await message_service.save_message(
            conversation_id, data.get("content"), data.get("sender"), jwt_token
        )
        return result
    except Exception as e:
...
async def complete_onboarding(
    ...
    try:
        ...
        result = await user_profile_service.complete_onboarding(
            user.id, data, jwt_token
        )
        return result
    except Exception as e:
