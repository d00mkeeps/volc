...
class VolumeCalculator:
    ...
    def calculate(raw_workout_data: Dict, limit: int = 3) -> VolumeCalculatorResult:
        ...
        try:
            ...
            exercise_metrics, time_series_data = VolumeCalculator._track_exercise_performance(workouts)
            ...
            top_performers = [
                TopPerformer(**result) for result in results[:limit]
            ]
            ...
            logger.info(f"Found {len(results)} exercises with volume data, returning top {limit}")
    ...
    def _track_exercise_performance(workouts: List[Dict]) -> tuple[Dict[str, Dict], Dict[str, List[Dict]]]:
        ...
        for workout in workouts:
            ...
            for exercise in workout.get('exercises', []):
                ...
                total_volume = VolumeCalculator._calculate_total_volume_for_exercise(exercise)
